...
#     instrumentID = appconsant.instrumentID
    ...
    feed1.addBarsFromCSV(instrumentID, date+instrumentID+".csv")
    myStrategy1 = MyStrategyRSI1(feed1,instrumentID, 660,200,100,57,45,appconsant.waveseg_nwaveticket,appconsant.waveseg_y,appconsant.waveseg_x,appconsant.waveseg_rongren)
