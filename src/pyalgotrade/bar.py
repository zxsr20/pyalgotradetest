...
class BasicBar(Bar):
    ...
    def __init__(self, dateTime, open_, high, low, close, volume, adjClose,bidvol,askvol, frequency):
#         if high < low:
...
#             raise Exception("low > close on %s" % (dateTime))
        ...
        self.__bidvol = bidvol
        self.__askvol = askvol
    ...
    def getBid1(self, adjusted=False):
        return self.__open
        
    def getAsk1(self, adjusted=False):
        return self.__close

    def getLastPrice(self, adjusted=False):
        return self.__high
    ...
    def getAdjClose(self,adjusted=False):
    ...
    def getBidVol(self):
        return self.__bidvol
    
    def getAskVol(self):
        return self.__askvol
