...
#                 if str(dateTime) > '2013-12-18 10:43:46':
#                     i = 1
                ...
                if str(dateTime) > '2013-12-18 10:43:45' and str(dateTime) > '2013-12-18 10:44:45':
                    print str(dateTime)+" "+str(prevValue)+" "+str(currValue)+" "+str(currGain)+" "+str(currLoss)+" "+str(avgGain)+" "+str(avgLoss)
#                     i = 
            if avgLoss == 0:
                self.__value = 100
            else:
