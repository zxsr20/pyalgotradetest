...
#         pyalgotrade.logger.file_log = pyalgotrade.logger.celue + pyalgotrade.logger.celuedate +'_log.txt'
#         self.__logger = pyalgotrade.logger.getLogger("server")
        self.__logger = pyalgotrade.logger.getLogger(pyalgotrade.logger.celue + pyalgotrade.logger.celuedate)
        self.__logger.setLevel(logging.DEBUG)
        dir = 'D:\\celuelog\\'+pyalgotrade.logger.celuedate+'\\'+pyalgotrade.logger.celue
        if os.path.exists(dir) == False:
            os.makedirs(dir)
        fileHandler = logging.FileHandler(dir +'\\' +pyalgotrade.logger.celue + pyalgotrade.logger.celuedate +'_log.txt')
...
#             print 'server celue'+pyalgotrade.logger.celue
...
#                 print >>appconsant.resultfile,"Best final result %s with parameters: %s from client %s" % (bestJob.getBestResult(), bestJob.getBestParameters(), bestJob.getBestWorkerName())
