...
#         self.__shortEMA = ma.EMA(self.__priceDS, shortSMA)
        ...
        self.ruchang1 = 0
        self.waven = 4
        self.n = 300#有n个点没有创新高
        self.a = 5 #亏损了a个点平仓
        self.b = 4 #盈利了b个点，并且c个点没有创新高，平
        self.c = 10
#         self.e = 2
        self.d = 6 #盈利了d个点，并且f个点没有创新高，平
        self.f = 20 
        self.g = 8 #盈利了g个点，并且h个点没有创新高，平
        self.h = 5 
...
#                 self.pricemax1 = bar.getPrice()
            ...
            if len(self.price1waveDS) > 1:
                if ((self.price1waveDS[-2] > 0 and self.price1waveDS[-1] < 0) or (self.price1waveDS[-1] < 0 and self.price1waveDS[-2] > 0)) and abs(self.price1waveDS[-1]) >= 3:
                    self.stress = self.price1waveDS[-1]
                if ((self.stress < 0 and self.price1waveDS[-1] < 0) or (self.stress > 0 and self.price1waveDS[-1] > 0)) and abs(self.price1waveDS[-1]) - abs(self.stress) >=4 :
                    if self.price1waveDS[-2] == self.price1waveDS[-1]:
                        self.equalcount += 1
                    else:
                        self.equalcount = 0
                    if self.equalcount > 6:
            ...
            if self.__shortPos11 != None and self.__shortPos11.entryFilled():
                ...
                if self.nonewtop11 > self.n:
                ...
                elif self.__shortPos11.getEntryOrder().getAvgFillPrice() - self.__priceDS1[-1]  > self.b and self.nonewtop11 > self.c:
                    ...
                    self.topprice11 = 0.0
                    printLog(self.__instrument1+'做空平仓')
                elif self.__shortPos11.getEntryOrder().getAvgFillPrice() - self.__priceDS1[-1]  > self.g and self.nonewtop11 > self.h:
...
#                         self.ruchang1 = 1#向外对冲
            ...
            if self.__shortPos12 != None and self.__shortPos12.entryFilled():
                ...
                if self.nonewtop12 > self.n:
                    ...
                    self.topprice12 = 0.0
                    printLog(self.__instrument1+'做空平仓')
                elif self.__shortPos12.getEntryOrder().getAvgFillPrice() - self.__priceDS1[-1]  > self.b and self.nonewtop12 > self.c:
                    ...
                    self.topprice12 = 0.0
                    printLog(self.__instrument1+'做空平仓')
                elif self.__shortPos12.getEntryOrder().getAvgFillPrice() - self.__priceDS1[-1]  > self.g and self.nonewtop12 > self.h:
            ...
            if self.__longPos11 != None and self.__longPos11.entryFilled():
                ...
                if self.nonewtop11 > self.n:
                ...
                elif self.__priceDS1[-1] - self.__longPos11.getEntryOrder().getAvgFillPrice() > self.a:
                    printLog(self.__instrument1+'self.equalcount > 6当前已经亏损'+str(self.a)+'，准备平仓')
                    self.__longPos11.exitMarket()
                    self.nonewtop11 =  0
                    self.topprice11 = 0.0
                ...
                elif self.__priceDS1[-1] - self.__longPos11.getEntryOrder().getAvgFillPrice()  > self.b and self.nonewtop11 > self.c:
                    printLog(self.__instrument1+'self.equalcount > 6当前已经盈利'+str(self.b)+'，准备平仓')
                    self.__longPos11.exitMarket()
                    self.nonewtop11 =  0
                    self.topprice11 = 0.0
                    ...
                    self.topprice11 = 0.0
                    printLog(self.__instrument1+'做多平仓')
                elif self.__priceDS1[-1] - self.__longPos11.getEntryOrder().getAvgFillPrice()  > self.g and self.nonewtop11 > self.h:
                    printLog(self.__instrument1+'self.equalcount > 6当前已经盈利'+str(self.g)+'，准备平仓')
                    self.__longPos11.exitMarket()
                    self.nonewtop11 =  0
                    self.topprice11 = 0.0
...
#                         self.ruchang1 = 1#向外对冲
            ...
            if self.__longPos12 != None and self.__longPos12.entryFilled():
                ...
                if self.nonewtop12 > self.n:
                    ...
                    self.topprice12 = 0.0
                    printLog(self.__instrument1+'做多平仓')
                elif self.__priceDS1[-1] - self.__longPos12.getEntryOrder().getAvgFillPrice()   > self.b and self.nonewtop12 > self.c:
                    printLog(self.__instrument1+'self.equalcount2 > 3当前已经盈利'+str(self.b)+'，准备平仓')
                    self.__longPos12.exitMarket()
                    self.nonewtop12 =  0
                    self.topprice12 = 0.0
                    ...
                    self.topprice12 = 0.0
                    printLog(self.__instrument1+'做多平仓')
                elif self.__priceDS1[-1] - self.__longPos12.getEntryOrder().getAvgFillPrice()  > self.g and self.nonewtop12 > self.h:
                    printLog(self.__instrument1+'self.equalcount2 > 3当前已经盈利'+str(self.g)+'，准备平仓')
                    self.__longPos12.exitMarket()
                    self.nonewtop12 =  0
                    self.topprice12 = 0.0
            ...
            if self.__shortPos13 != None and self.__shortPos13.entryFilled():
                ...
                if self.nonewtop13 > self.n:
                    ...
                    self.topprice13 = 0.0
                    printLog(self.__instrument1+'做空平仓')
                elif self.__shortPos13.getEntryOrder().getAvgFillPrice() - self.__priceDS1[-1]  > self.b and self.nonewtop13 > self.c:
                    ...
                    self.topprice13 = 0.0
                    printLog(self.__instrument1+'做空平仓')
                elif self.__shortPos13.getEntryOrder().getAvgFillPrice() - self.__priceDS1[-1]  > self.g and self.nonewtop13 > self.h:
            ...
            if self.__longPos13 != None and self.__longPos13.entryFilled():
                ...
                if self.nonewtop13 > self.n:
                ...
                elif self.__priceDS1[-1] - self.__longPos13.getEntryOrder().getAvgFillPrice()     > self.b and self.nonewtop13 > self.c:
                    printLog(self.__instrument1+'当前已经盈利'+str(self.b)+'，准备平仓')
                    self.__longPos13.exitMarket()
                    self.nonewtop13 =  0
                    self.topprice13 = 0.0
                    ...
                    self.topprice13 = 0.0
                    printLog(self.__instrument1+'做多平仓')
                elif self.__priceDS1[-1] - self.__longPos13.getEntryOrder().getAvgFillPrice()   > self.g and self.nonewtop13 > self.h:
                    printLog(self.__instrument1+'当前已经盈利'+str(self.g)+'，准备平仓')
                    self.__longPos13.exitMarket()
                    self.nonewtop13 =  0
                    self.topprice13 = 0.0
