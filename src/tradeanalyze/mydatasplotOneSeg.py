...
def main():
    ...
    myStrategy = MyStrategyRSI(feed,"rb1510", 660,200,100,57,45)
    ...
    plt.getInstrumentSubplot("rb1510").addDataSeries("segmentDS", myStrategy.getsegment())
    ...
    print >>logfile,'allseglen:'+str(allseglen)+'alldiffprinum:'+str(u) + 'needcountdiffcount:'+str(x)
